                ...
                difference() {
                    union() {
                        ...
                        difference() {
                            ...
                            translate([0,0,aluminium_ring_section_with + top_width + grip_cone_width + middle_section_cone_width + bottom_section_cone_width - bottom_opening_width]) cylinder(h=bottom_opening_width, r=bottom_opening_radius);
                        }
                        if(button_half) {
                            difference() {
